...
// Show it all, with the given config, otherwise with default settings
    Celestial.display = function (config) {
        ...
        function reproject(config) {
            ...
            var rot = mapProjection.rotate(), ctr = mapProjection.center(), sc = mapProjection.scale(),
                ext = zoom.scaleExtent(), clip = [],
        ...
        function redraw() {
            ...
            if (cfg.mw.show) {
                ...
                if (cfg.transform !== "supergalactic" && cfg.background.opacity > 0.95)
                    container.selectAll(".mwbg").each(function (d) {
        ...
        function animate() {
            ...
            switch (a.param) {
                case "projection":
                    d = reproject({projection: a.value});
                    break;
                case "center":
                    d = rotate({center: a.value});
                    break;
                case "zoom":
                    d = zoomBy(a.value);
            }
...
if (typeof module === "object" && module.exports) {
    ...
    module.exports = {
        Celestial: function () {
            return createCelestial();
        },
        createCelestial: function () {
            return createCelestial;
        },
        d3: function () {
            return d3js;
